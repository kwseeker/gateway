module github.com/kwseeker/gateway/gateway-test-provider-interfaces

go 1.17

require github.com/dubbogo/gost v1.13.2

require (
	dubbo.apache.org/dubbo-go/v3 v3.0.2
	github.com/kwseeker/gateway/gateway-test-provider-rpc v0.0.1
)
...
replace github.com/kwseeker/gateway/gateway-test-provider-rpc => /home/lee/mywork/go/src/github.com/kwseeker/gateway/gateway-test-provider-rpc
